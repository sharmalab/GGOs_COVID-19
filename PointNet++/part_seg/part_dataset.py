...
##### Monjoy Start ######   
    ...
    ##### Monjoy End ###### 
        ...
        for item in self.cat:
            ...
            dir_seg = os.path.join(self.root, self.cat[item], 'expert_verified/points_label')
...
if __name__ == '__main__':
    d = PartDataset(root = '../data/shapenetcore_partanno_segmentation_benchmark_v0', class_choice = ['Lung'], split='test')
