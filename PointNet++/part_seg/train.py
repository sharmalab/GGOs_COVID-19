...
parser.add_argument('--log_dir', default='log_epoch200', help='Log dir [default: log]')
...
DATA_PATH = os.path.join(ROOT_DIR, 'data', '1_Point_cloud_data_3Feb2021')
print(DATA_PATH)
#pdb.set_trace()
...
def eval_one_epoch(sess, ops, test_writer):
    ...
    seg_label_to_cat = {} # {0:Lung, 1:Lung, ...49:Table}
    ...
    mean_shape_ious = list(shape_ious.values())
    mean_shape_ious = np.mean(mean_shape_ious)
